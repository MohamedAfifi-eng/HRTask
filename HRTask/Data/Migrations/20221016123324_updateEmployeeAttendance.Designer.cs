...
namespace HRTask.Data.Migrations
{
    ...
    [Migration("20221016123324_updateEmployeeAttendance")]
    partial class updateEmployeeAttendance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HRTask.Models.AnnualVacation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRTask.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("HRTask.Models.EmployeeAttendance", b =>
                {
                    ...
                    b.Property<decimal?>("calculatedPonus")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("HRTask.Models.GroupScreens", b =>
                {
                    ...
                    b.HasIndex("ScreenId_FK");

                    b.ToTable("GroupScreens");
                });

            modelBuilder.Entity("HRTask.Models.Screen", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HRTask.Models.GroupScreens", b =>
                {
                    b.HasOne("HRTask.Models.Group", "Group")
                        .WithMany("GroupScreens")
                        .HasForeignKey("GroupId_FK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("HRTask.Models.Screen", "Screen")
                        .WithMany("GroupScreens")
                        .HasForeignKey("ScreenId_FK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("HRTask.Models.ApplicationUser", null)
                        .WithMany()
